    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick={() => navigate("cart")} className="relative cursor-pointer">
                    <img src={assets.cart_icon} alt="Cart" className="w-4 h-4 cursor-pointer" />
                ...
                (
                    <div className='relative group'>
                        <img src={assets.profile} alt="" className="w-4 h-4 cursor-pointer" />
                        <ul className='hidden group-hover:block absolute top-6 right-0 bg-white border border-gray-300 shadow-md rounded-md w-32 text-sm'>
